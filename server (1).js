...
async function checkEligibility(driver) {
    return new Promise(async (resolve, reject) => {
        try {
            let status;
            let dob = 0;//*[@id="trnEligibilityStatus"]
    ...
    return new Promise(async (resolve, reject) => {
        try {
            ...
            if (ID && lastName && firstName) {
                ...
                // await driver.findElement(By.name("EligibilityRequestTemplateInquiry.EligibilityRequestFieldValues.InsuranceNum")).sendKeys("username")
                // await driver.findElement(By.name("EligibilityRequestTemplateInquiry.EligibilityRequestFieldValues.InsuranceNum")).sendKeys("username")
                // const text = await driver.findElement(By.name("EligibilityRequestTemplateInquiry.EligibilityRequestFieldValues.InsuranceNum")).getAttribute('name')
                // console.log("text", text)
                setTimeout(async () => {
                    // await driver.wait(until.elementLocated(By.xpath("//*[@id='EligibilityRequestTemplateInquiry_EligibilityRequestFieldValues_InsuranceNum']")), 20000).click()
                    ...
                    // await driver.wait(until.elementLocated(By.xpath("//*[@id='EligibilityRequestTemplateInquiry_EligibilityRequestFieldValues_InsuredFirstName']")), 20000).click()
